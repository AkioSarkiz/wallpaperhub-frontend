...
export default async function HomePage() {
  const wallpapersData = await backendFetch<{ data: IWallpaperAPI[] }>(
    "api/v1/wallpapers?limit=10",
  );
    ...
    <main className="container mx-auto px-4 py-8">
      ...
      <section className="mb-12 text-center">
        ...
        <p className="mx-auto mb-8 max-w-2xl text-pretty text-lg text-muted-foreground">
          Browse thousands of high-quality wallpapers for your desktop, mobile,
          and tablet. Free to download and use.
        </p>
